...
If you run this, you’ll find you can now browse to the home page [http://localhost:3000](http://localhost:3000) and the About page [http://localhost:3000/about](http://localhost:3000/about). Any query strings will be ignored (so [http://localhost:3000/?foo=bar](http://localhost:3000/?foo=bar) will serve the home page), and any other URL [http://localhost:3000/foo](http://localhost:3000/foo) will serve the Not Found page.
